  ...
  return (
    <>
        <Global 
            ...
            `}
        />
        <div id={`show_${key_id}`} tabIndex={-2} style="background: red;outline: 0;" className='hoverProjects titleProjectsContent' /* onMouseEnter={() => showCard()} onMouseLeave={() => hideCard()} */ >
